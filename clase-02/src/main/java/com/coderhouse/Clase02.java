...
public class Clase02 {
	...
	public static void main(String[] args) {
		...
		case 1:
			nombreDelDia = "Lunes";
			System.out
					.println("El dia se la semana correspondiente al numero " + numeroDeDia + " es el " + nombreDelDia);
			break;
		case 2:
			nombreDelDia = "Martes";
			System.out
		...
		System.out.println("El dia se la semana correspondiente al numero " + numeroDeDia + " es el " + nombreDelDia);
